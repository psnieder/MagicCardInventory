...
# Command Line Arguments: 
	...
	1 - Scryfall card ID from scryfall API found at https://scryfall.com. A comma separated list of IDs can be passed to inventory multiple cards at a time. If argument 2 is passed in, it will apply to all cards in the list. Argument 3 cannot be used with this option.
